...
import "./Rarity.scss";
import rarityRightImg from "../../Images/rarity.png";
import rarityRightImgMobile from "../../Images/rarity-mobile.png";
        ...
        <div className="rarity__left">
          ...
          <div className="rarity__content content">
            <p>Love Cupids are generated from approximately 135 unique traits in 14 categories, resulting in over 5 trillion unique Love Cupids.
              <br />
              <br />
              Please explore our <Link smooth to="/cupids/chart"> rarity chart! </Link>
            </p>
          </div>
        </div>
